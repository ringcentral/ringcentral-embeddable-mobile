...
function login(msg = postMessage) {
  const c = getCode();
...
class App extends external_React_namespaceObject.Component {
  ...
  render() {
    const url = this.isIOS ? window.rc.server + '/embeddable/app.html' + window.rc.appConfigQuery : 'https://ringcentral.github.io/ringcentral-embeddable/app.html' + window.rc.appConfigQuery;
